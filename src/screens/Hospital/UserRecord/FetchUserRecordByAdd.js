...
const UserRecordByAdd = () => {
    ...
    const getRecords = () => (<div className={styles.hospitalContainer}>
    ...
    const showEmptyRecord = () => {
        ...
        return <>
            <img style={{ margin: '10px auto' }} src={'https://counter-form.com/pgd/assets/img/bar_icon/No-record-found.png'} alt="loading..." />
        </>
    }
